import {
    avatar1, avatar2, avatar3, avatar4, avatar5, avatar6, avatar7, avatar8, iconTotalUser, iconUserBaru, iconUserAktif, iconUserTidakAktif
} from '../../../image'


export const cardManageUsers = [
    {
        location: '/',
        image: iconTotalUser,
        text: 'Total User',
