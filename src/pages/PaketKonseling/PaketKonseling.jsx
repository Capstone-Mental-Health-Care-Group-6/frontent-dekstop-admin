...
const PaketKonseling = () => {
  ...
  formDataKeys.forEach((key) => {
    const value =
      key === "price"
        ...
        : key === "sessions" || key === "active_priode"
  ...
  const addKonseling = () =>
    toast.success("Paket konseling berhasil di tambahkan ✨🚀", {
      duration: 4000,
  ...
  const rejectKonseling = () =>
    toast.error(
      "Paket konseling gagal ditambah tolong periksa dan masukan data yang sesuai ",
      {
        duration: 5000,
        position: 'position="bottom-center',
        className: "custom-toast-payment",
  ...
  return (
    <Layouts titlePage={"Paket Konseling"}>
      <section
        className="paket-konseling position-relative"
        id="paket-konseling"
      >
        <section className="add-konseling mt-4">
          <div className="d-flex align-items-center justify-content-between p-4 rounded-3 bg-white flex-md-row flex-column">
            ...
            <button
              className="btn-add d-flex btn align-items-center justify-content-center fw-semibold gap-1"
              ...
              <form className="p-3">
                <div className="position-relative mx-auto">
                  <div className="image d-flex justify-content-center ">
                    ...
                    />
                    <button
                      className="btn border-0 position-absolute bottom-0 end-0"
                      type="button"
                    >
                ...
                <label htmlFor="description" className="fw-semibold mt-2 mb-2">
                  Keterangan Paket
                </label>
                    ...
                    <div className="card-header border-0">
                      <div className="d-flex align-items-center justify-content-between">
                        <div className=" d-flex gap-3 align-items-center ">
                          ...
                          <div>
                            <h6 className="m-0 text-black fw-medium">
                              {item.name}{" "}
                            </h6>
                        ...
                        <ul className="dropdown-menu px-1">
                          ...
                          <li>
                            ...
                            <button
                              ...
                              data-bs-toggle="modal"
                              data-bs-target={`#alert-delete${item.id}`}
                            >
                              {" "}
                              Hapus{" "}
                            </button>{" "}
                    ...
                    <ModalAlert id={`modal-edit${item.id}`}>
                      ...
                      <form onSubmit={handleSubmit} className="p-3">
                        <div className="position-relative mx-auto">
                          <div className="image d-flex justify-content-center ">
                            {formData.avatar &&
                            formData.avatar instanceof Blob ? (
                              <img src={URL.createObjectURL(formData.avatar)} />
                            ) : item.avatar ? (
                        ...
                        <label
                          htmlFor="description"
                          className="fw-semibold mt-2 mb-2"
                        >
                          Keterangan Paket
                        </label>
                        <div className="form-floating ">
                        ...
                        <div className="d-flex gap-2 float-end">
                          <Button
                            className={
                              "btn border-primary text-primary fw-medium"
                            }
                            text="Batal"
                            bsTogle={"modal"}
                            bsTarget={"#modal-batal-edit"}
                          />
                          <Button
                            className={"btn bg-primary text-white fw-medium"}
                            text="Simpan"
                            onClick={() => handleUpdateBundle(item.id)}
                            bsDismiss={"modal"}
                          />
                        </div>
                      </form>
                      ...
                      <div className="alert-modal-delete p-3">
                        <div className="d-flex flex-column justify-content-center align-items-center mb-3">
                          ...
                          <div className="text-center">
                            ...
                            <span>
                              Tindakan ini akan menghapus data pada paket
                              konseling ini, data yang dihapus tidak dapat
                              dikembalikan
                            </span>
                          </div>
                        </div>
              ...
              <div className="alert-modal-batal-edit p-3">
                <div className="d-flex flex-column justify-content-center align-items-center mb-3">
                  ...
                  <div className="text-center">
                    ...
                    <span>
                      Tindakan ini akan membuat data yang Anda masukan menjadi
                      tidak tersimpan
                    </span>
                  </div>
                </div>
                ...
                <div className="d-flex gap-2 justify-content-end">
                  ...
                  />
                  <Button
                    className={"btn  text-primary border-primary fw-medium"}
                    bsDismiss={"modal"}
                    text="Ya"
                    onClick={deleteState}
                  />
